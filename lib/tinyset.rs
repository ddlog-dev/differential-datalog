...
pub fn insert_imm<X: u64set::Fits64 + Clone>(
    s: &Set64<X>,
    v: &X,
) -> Set64<X> {
    let mut s2 = s.clone();
...
pub fn nth<X: u64set::Fits64 + Ord + Clone>(
    s: &Set64<X>,
    n: &u64,
...
pub fn union<X: u64set::Fits64 + Clone>(
    s1: &Set64<X>,
    s2: &Set64<X>,
) -> Set64<X> {
    let s = s1.x.clone();
...
pub fn unions<X: u64set::Fits64 + Clone>(
    sets: &crate::ddlog_std::Vec<Set64<X>>,
) -> Set64<X> {
...
pub fn intersection<X: u64set::Fits64 + Clone>(
    s1: &Set64<X>,
    s2: &Set64<X>,
) -> Set64<X> {
    let mut s = u64set::Set64::new();
...
pub fn difference<X: u64set::Fits64 + Clone>(
    s1: &Set64<X>,
    s2: &Set64<X>,
) -> Set64<X> {
    Set64 {
