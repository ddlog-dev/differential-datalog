...
impl<K: ri::RangeInternerKey + std::fmt::Debug, V: ri::RangeInternerVal<V> + std::fmt::Debug>
    std::fmt::Debug for range_mapper_Mapper<K, V>
{
...
impl<K: ri::RangeInternerKey + std::fmt::Debug, V: ri::RangeInternerVal<V> + std::fmt::Debug>
    std::fmt::Display for range_mapper_Mapper<K, V>
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        std::fmt::Debug::fmt(&self.interner, f)
    }
...
impl<K: ri::RangeInternerKey, V: ri::RangeInternerVal<V>> serde::Serialize
    for range_mapper_Mapper<K, V>
{
...
impl<'de, K: ri::RangeInternerKey, V: ri::RangeInternerVal<V>> serde::Deserialize<'de>
    for range_mapper_Mapper<K, V>
{
        ...
        D: serde::Deserializer<'de>,
    {
        Err(<D::Error as serde::de::Error>::custom(
            "range_mapper.Mapper.deserialize() is not implemented",
        ))
    }
}
...
impl<K: ri::RangeInternerKey, V: ri::RangeInternerVal<V>> record::Mutator<range_mapper_Mapper<K, V>>
    for record::Record
{
...
impl<K: ri::RangeInternerKey, V: ri::RangeInternerVal<V>> std::hash::Hash
    for range_mapper_Mapper<K, V>
{
...
impl<K: ri::RangeInternerKey + std::fmt::Debug, V: ri::RangeInternerVal<V> + std::fmt::Debug>
    std::fmt::Debug for range_mapper_Mapping<K, V>
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
...
impl<
        K: ri::RangeInternerKey + std::fmt::Display + Clone,
        V: ri::RangeInternerVal<V> + std::fmt::Display,
    > std::fmt::Display for range_mapper_Mapping<K, V>
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_fmt(format_args!(
            "({}->{})",
            range_mapper_mkey(self),
            range_mapper_mval(self)
        ))
    }
}

impl<K: ri::RangeInternerKey + Default + Clone, V: ri::RangeInternerVal<V>> Default
    for range_mapper_Mapping<K, V>
{
    fn default() -> Self {
    ...
    for range_mapper_Mapping<K, V>
{
        ...
        S: serde::Serializer,
    {
        Err(<S::Error as serde::ser::Error>::custom(
            "range_mapper.Mapping.serialize() is not implemented",
        ))
    }
}
    ...
    for range_mapper_Mapping<K, V>
{
    ...
    {
        Err(<D::Error as serde::de::Error>::custom(
            "range_mapper.Mapping.deserialize() is not implemented",
        ))
    }
}

impl<K: ri::RangeInternerKey, V: ri::RangeInternerVal<V>> FromRecord
    for range_mapper_Mapping<K, V>
{
    fn from_record(val: &record::Record) -> Result<Self, String> {
...
impl<K: ri::RangeInternerKey + IntoRecord + Clone, V: ri::RangeInternerVal<V> + IntoRecord>
    IntoRecord for range_mapper_Mapping<K, V>
{
    fn into_record(self) -> record::Record {
        record::Record::Tuple(vec![
            range_mapper_mkey(&self).into_record(),
            range_mapper_mval(&self).into_record(),
        ])
    }
}

impl<K: ri::RangeInternerKey, V: ri::RangeInternerVal<V>>
    record::Mutator<range_mapper_Mapping<K, V>> for record::Record
{
...
pub fn range_mapper_get_mapping<K, V>(
    mapper: &range_mapper_Mapper<K, V>,
    k: &K,
) -> range_mapper_Mapping<K, V>
where
